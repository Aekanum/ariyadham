...
**Cardinality:** articles (_:_) categories
...
**Cardinality:** articles (1:_) comments, users (1:_) comments
...
**Cardinality:** articles (1:_) anjali_reactions, users (1:_) anjali_reactions
...
**Cardinality:** articles (1:_) bookmarks, users (1:_) bookmarks
...
**Cardinality:** articles (1:_) reading_history, users (1:_) reading_history
